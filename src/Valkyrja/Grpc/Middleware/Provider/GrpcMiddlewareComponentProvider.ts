...
import { GrpcMiddlewareServiceProvider } from './GrpcMiddlewareServiceProvider.ts';
...
export class GrpcMiddlewareComponentProvider implements ComponentProviderContract {
    ...
    getContainerProviders(_app: ApplicationContract): ServiceProviderContract[] {
        return [new GrpcMiddlewareServiceProvider()];
    }
