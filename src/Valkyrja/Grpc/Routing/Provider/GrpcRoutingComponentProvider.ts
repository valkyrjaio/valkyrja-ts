...
import { GrpcRoutingServiceProvider } from './GrpcRoutingServiceProvider.ts';
...
export class GrpcRoutingComponentProvider implements ComponentProviderContract {
    ...
    getContainerProviders(_app: ApplicationContract): ServiceProviderContract[] {
        return [new GrpcRoutingServiceProvider()];
    }
