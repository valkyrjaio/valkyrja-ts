...
import { HttpServerServiceProvider } from './HttpServerServiceProvider.ts';
...
export class HttpServerComponentProvider implements ComponentProviderContract {
    ...
    getContainerProviders(_app: ApplicationContract): ServiceProviderContract[] {
        return [new HttpServerServiceProvider()];
    }
