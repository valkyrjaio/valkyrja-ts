...
export class Char {
     ...
     */
    static readonly UNRESERVED = String.raw`a-zA-Z0-9_\-\.~`;
     ...
     */
    static readonly SUB_DELIMS = String.raw`!\$&'\(\)\*\+,;=`;
     ...
     */
    static readonly USER_INFO = Char.UNRESERVED + Char.SUB_DELIMS + ':';
     ...
     */
    static readonly HOST = Char.UNRESERVED + Char.SUB_DELIMS;
     ...
     */
    static readonly PATH = Char.UNRESERVED + Char.SUB_DELIMS + String.raw`:@\/`;
     ...
     */
    static readonly QUERY = Char.PATH + String.raw`\?`;
}
